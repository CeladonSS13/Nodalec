...
/obj/effect/collapsing_demonic_portal/drop_loot()
	...
	switch(loot)
		...
		if(5)//syndicate incursion. Again, high-quality loot at low chances, this time with excessive levels of danger
			...
			playsound(loc,'sound/music/antag/traitor/tatoralert.ogg', 75, FALSE, 50, TRUE, TRUE)
			if(prob(25))
				if(prob(25))
		...
		if(6)//;HELP BLOB IN MEDICAL
			...
			playsound(loc,'sound/announcer/alarm/bloblarm.ogg', 50, FALSE, 50, TRUE, TRUE)
			if(prob(35))
...
//				new /obj/item/gem/bloodstone(loc)
		...
		if(12)//miner's last moments
			...
			playsound(loc,'sound/ambience/weather/ashstorm/inside/weak_end.ogg', 150, FALSE, 50, TRUE, TRUE)
			if(prob(25))
		...
		if(13)//sailing the ocean blue
			...
			playsound(loc,'nodalec/master_files/sound/ambience/shore.ogg', 150, FALSE, 50, TRUE, TRUE)
		...
		if(15)//fallout ss13
			...
			if(prob(35))
				new /obj/item/gun/energy/e_gun/mini/practice_phaser(loc)
				new /mob/living/basic/cockroach/glockroach(loc)
		...
		if(23)//Research & Zombies
			...
			playsound(loc,'sound/announcer/alarm/bloblarm.ogg', 120, FALSE, 50, TRUE, TRUE)
			if(prob(35))
