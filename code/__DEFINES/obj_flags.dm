...
#define RENAME_NO_DESC (1<<5) // if it can be renamed, is its description excluded?
...
#define CONDUCTS_ELECTRICITY (1<<14) //! Can this object conduct electricity?
#define NO_DEBRIS_AFTER_DECONSTRUCTION (1<<15) //! Atoms don't spawn anything when deconstructed. They just vanish
// [/NODALEC-EDIT]
